...
Main Streamlit entry point — bootstraps the KUMIP dashboard.
...
st.markdown(
    ...
    "<h1 style='font-size:2.4rem;font-weight:700;margin:10px 0 6px'>KUMIP</h1>"
    "<h2 style='font-size:1.3rem;font-weight:400;color:#8b9ab0;margin:0 0 20px'>"
    "Kenya Urban Mobility Intelligence Platform</h2>"
