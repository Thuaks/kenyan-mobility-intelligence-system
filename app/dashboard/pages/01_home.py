...
with st.sidebar:
    st.markdown("## 🚦 NUMIP")
    st.markdown("<span style='color:#8b9ab0;font-size:0.82rem'>Nairobi Urban Mobility<br>Intelligence Platform</span>", unsafe_allow_html=True)
    ...
    st.divider()
    st.markdown("<span style='color:#8b9ab0;font-size:0.75rem'>Data: NTSA · OSM · NASA · X/Twitter<br>Models: XGBoost · Prophet · DBSCAN · VADER<br><br>Built by <b style='color:#8b9ab0'>Alex Thuku</b></span>", unsafe_allow_html=True)
